 ...
 * @author Павел
 */
public class CalibrationAct extends javax.swing.JFrame {

    /**
     * Creates new form CalibrationAct
     */
    public CalibrationAct() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Акт проведения тарировочных равбот");

        jLabel3.setText("Дата");

        jLabel4.setText("Организация-заказчик");

        jLabel5.setText("Место установки");

        jLabel6.setText("Модель");

        jLabel7.setText("Государственные номер ТС");

        jLabel8.setText("Количество баков");

        jLabel9.setText("Тарировка");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Поочередная", "Одновременная" }));

        jLabel10.setText("Топливо перед тарировкой");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Слито", "Не слито" }));

        jLabel11.setText("Объем слитого топлива");

        jLabel12.setText("Объем бака по паспорту ТС");

        jLabel13.setText("Количество топлива для тарировки");

        jLabel14.setText("Бак заполнен на");

        jLabel15.setText("ДУТ НЕ ПО ЦЕНТРУ ПРИЧИНА");

        jLabel16.setText("Топливо предоставлено");

        jCheckBox1.setText("бочка");

        jLabel17.setText("Марка АТЗ");

        jButton1.setText("Обзор");

        jLabel18.setText("Фамилия");

        jLabel19.setText("Имя");

        jLabel20.setText("Отчество");

        jLabel21.setText("Работу принял");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalibrationAct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalibrationAct().setVisible(true);
            }
        });
    }
